...
// ============================================
ring_libinit! {
    "uuid_v4" => ring_uuid_v4,
    "uuid_v7" => ring_uuid_v7,
    "uuid_nil" => ring_uuid_nil,
    "uuid_max" => ring_uuid_max,
    "uuid_parse" => ring_uuid_parse,
    "uuid_is_valid" => ring_uuid_is_valid,
    "uuid_get_version" => ring_uuid_get_version,
    "uuid_get_variant" => ring_uuid_get_variant,
    "uuid_to_string" => ring_uuid_to_string,
    "uuid_to_upper" => ring_uuid_to_upper,
    "uuid_to_simple" => ring_uuid_to_simple,
    "uuid_to_urn" => ring_uuid_to_urn,
    "uuid_to_braced" => ring_uuid_to_braced,
    "uuid_equals" => ring_uuid_equals,
    "uuid_is_nil" => ring_uuid_is_nil,
    "uuid_is_max" => ring_uuid_is_max,
    "uuid_compare" => ring_uuid_compare,
    "uuid_to_hex" => ring_uuid_to_hex,
    "uuid_from_hex" => ring_uuid_from_hex,
    "uuid_batch_v4" => ring_uuid_batch_v4,
    "uuid_batch_v7" => ring_uuid_batch_v7,
    "uuid_v7_timestamp_ms" => ring_uuid_v7_timestamp_ms,
    "uuid_v7_from_timestamp_ms" => ring_uuid_v7_from_timestamp_ms
}
