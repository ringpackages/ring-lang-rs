...
// ============================================
ring_libinit! {
    b"json_parse\0" => ring_json_parse,
    b"json_is_valid\0" => ring_json_is_valid,
    b"json_prettify\0" => ring_json_prettify,
    b"json_minify\0" => ring_json_minify,
    b"json_get_string\0" => ring_json_get_string,
    b"json_get_number\0" => ring_json_get_number,
    b"json_get_int\0" => ring_json_get_int,
    b"json_get_bool\0" => ring_json_get_bool,
    b"json_get_json\0" => ring_json_get_json,
    b"json_has_path\0" => ring_json_has_path,
    b"json_get_type\0" => ring_json_get_type,
    b"json_array_len\0" => ring_json_array_len,
    b"json_array_get\0" => ring_json_array_get,
    b"json_object_keys\0" => ring_json_object_keys,
    b"json_object_len\0" => ring_json_object_len,
    b"json_set_string\0" => ring_json_set_string,
    b"json_set_number\0" => ring_json_set_number,
    b"json_set_bool\0" => ring_json_set_bool,
    b"json_set_null\0" => ring_json_set_null,
    b"json_set_json\0" => ring_json_set_json,
    b"json_delete_path\0" => ring_json_delete_path,
    b"json_new_object\0" => ring_json_new_object,
    b"json_new_array\0" => ring_json_new_array,
    b"json_array_push\0" => ring_json_array_push,
    b"json_merge\0" => ring_json_merge,
    b"json_encode\0" => ring_json_encode,
    b"json_decode\0" => ring_json_decode
}
