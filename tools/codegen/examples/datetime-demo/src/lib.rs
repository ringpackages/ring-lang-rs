...
// ============================================
ring_libinit! {
    "dt_now_utc" => ring_dt_now_utc,
    "dt_now_local" => ring_dt_now_local,
    "dt_now_unix" => ring_dt_now_unix,
    "dt_now_unix_ms" => ring_dt_now_unix_ms,
    "dt_parse_rfc3339" => ring_dt_parse_rfc3339,
    "dt_parse_format" => ring_dt_parse_format,
    "dt_parse_date" => ring_dt_parse_date,
    "dt_from_unix" => ring_dt_from_unix,
    "dt_from_unix_ms" => ring_dt_from_unix_ms,
    "dt_format_datetime" => ring_dt_format_datetime,
    "dt_to_rfc3339" => ring_dt_to_rfc3339,
    "dt_to_rfc2822" => ring_dt_to_rfc2822,
    "dt_to_unix" => ring_dt_to_unix,
    "dt_get_year" => ring_dt_get_year,
    "dt_get_month" => ring_dt_get_month,
    "dt_get_day" => ring_dt_get_day,
    "dt_get_hour" => ring_dt_get_hour,
    "dt_get_minute" => ring_dt_get_minute,
    "dt_get_second" => ring_dt_get_second,
    "dt_get_weekday" => ring_dt_get_weekday,
    "dt_get_weekday_name" => ring_dt_get_weekday_name,
    "dt_get_day_of_year" => ring_dt_get_day_of_year,
    "dt_get_week_number" => ring_dt_get_week_number,
    "dt_add_days" => ring_dt_add_days,
    "dt_add_hours" => ring_dt_add_hours,
    "dt_add_minutes" => ring_dt_add_minutes,
    "dt_add_seconds" => ring_dt_add_seconds,
    "dt_add_weeks" => ring_dt_add_weeks,
    "dt_add_months" => ring_dt_add_months,
    "dt_add_years" => ring_dt_add_years,
    "dt_diff_days" => ring_dt_diff_days,
    "dt_diff_hours" => ring_dt_diff_hours,
    "dt_diff_minutes" => ring_dt_diff_minutes,
    "dt_diff_seconds" => ring_dt_diff_seconds,
    "dt_is_before" => ring_dt_is_before,
    "dt_is_after" => ring_dt_is_after,
    "dt_is_same_day" => ring_dt_is_same_day,
    "dt_create" => ring_dt_create,
    "dt_create_date" => ring_dt_create_date,
    "dt_start_of_day" => ring_dt_start_of_day,
    "dt_end_of_day" => ring_dt_end_of_day,
    "dt_is_valid" => ring_dt_is_valid,
    "dt_is_leap_year" => ring_dt_is_leap_year,
    "dt_days_in_month" => ring_dt_days_in_month
}
